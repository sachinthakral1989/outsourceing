...
function user() {
	...
	$("#forUser").removeClass("MyDisplayNone"); 
	$("#forBroker").addClass("MyDisplayNone"); 
	
}
function broker() {
   $("#forUser").addClass("MyDisplayNone"); 
	$("#forBroker").removeClass("MyDisplayNone"); 
...
<body>
    ...
    <ul class="dropdown-menu">
      <li><a href="#" data-toggle="tab" onclick="user()">User</a></li>
      <li class="divider"></li>
      <li><a href="boekerApproveRejectAction.jsp" data-toggle="tab" >Broker</a></li>
    </ul>
  </li>
          </ul>
