...
public class CartBean {
	...
	public void updateCartItem(String strItemIndex, String strQuantity) {
		...
		try {
			...
			System.out
					.println("Error while updating cart: " + nfe.getMessage());
			nfe.printStackTrace();
		}

	}

	public void addCartItem(String strDocumentId, String strUnitCost,
			String strQuantity,String image,String productTitle) {
		double dblTotalCost = 0.0;
		double dblUnitCost = 0.0;
		int iQuantity = 0;
		...
		try {
			...
			if (iQuantity > 0) {
				dblTotalCost = dblUnitCost * iQuantity;
				cartItem.setDocumetId(strDocumentId);
			...
			System.out
					.println("Error while parsing from String to primitive types: "
							+ nfe.getMessage());
			nfe.printStackTrace();
		}
	}
